...
1. You have three numbers called n1, n2, and n3 and you want to determine the value of each divided by the other.  Give three example numbers and the answers of all 6 divisions.  (Put the answers in comments after the divisions.) (Some example numbers: n1 = 3, n2 = 11, n3 = 19)
